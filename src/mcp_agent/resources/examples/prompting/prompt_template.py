...
class PromptTemplate:
    ...
    """
    def __init__(self, template_text: str, delimiter_map: Optional[Dict[str, str]] = None):
        """
    ...
    def _parse_template(self) -> List[PromptContent]:
        ...
        is_simple_mode = (
            first_non_empty_line and 
            first_non_empty_line not in delimiter_values
        )
...
class PromptTemplateLoader:
    ...
    def get_metadata(self, file_path: Path) -> PromptMetadata:
        ...
        is_simple_mode = (
            first_non_empty_line and 
            first_non_empty_line not in self.delimiter_map
        )
