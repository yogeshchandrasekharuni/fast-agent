...
Look at the `parallel.py` workflow example for more examples. If you don't specify a `fan-in` agent, the parallel returns the results from each Agent verbatim.
